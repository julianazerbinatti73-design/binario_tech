// src/controllers/scaniaController.js
...
const scaniaController = {
    // Renomeado para minúsculo por convenção
    listarTelemetria: (req, res) => {
        res.status(200).json({ montadora: "Scania", dados: telemetriaScania });
    },

    // Renomeado para criarTelemetria para coincidir com a sua rota
    criarTelemetria: (req, res) => {
